#F:\1KU_CPE\03603423 Network Programming 2562\Python Program\Network\MultiTread\ChatServer_M.py
'''Chat Server for a multi-client chat room''' # remark at first character
from socket import *
from threading import Thread
import threading
from time import ctime #นำเข้าโมดูล time เพื่อสร้างวันและเวลา
...
ID = "6130300417"
WelcomeMessage = "Welcome to " + ID + " Chatroom"
